...
@EnableJpaRepositories("ru.innopolis.publicator.DAO")
public class JPAConfig {


    public static final String URL_BASE = "jdbc:h2:~/publicator";

    public static final String DRIVER_DB = "com.h2.Driver";

    public static final String USERNAME_DB = "admin";

    public static final String PASSWORD_DB = "admin";
